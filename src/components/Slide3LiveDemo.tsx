      ...
      case 0:
        return (
          <div className="flex flex-col items-center justify-center h-full w-full">
            <div className="w-40 h-40 rounded-full border-[6px] border-slate-100 dark:border-[#0F172A] shadow-[inset_0_0_40px_rgba(232,88,15,0.1)] dark:shadow-[inset_0_0_40px_rgba(232,88,15,0.2)] flex items-center justify-center animate-pulse relative bg-white dark:bg-transparent">
               <div className="absolute inset-[-6px] rounded-full border-t-[6px] border-[#E74A33] dark:border-[#E74A33] animate-spin" />
               <Activity className="text-[#E74A33] dark:text-[#E74A33] w-16 h-16 drop-shadow-[0_0_15px_rgba(232,88,15,0.5)] dark:drop-shadow-[0_0_15px_#E8580F]" />
            </div>
            ...
            <div className="bg-white dark:bg-[#0A0F1A] border border-slate-200 dark:border-slate-700/60 shadow-lg dark:shadow-[0_10px_30px_rgba(0,0,0,0.5)] rounded-2xl p-8 w-[600px] max-w-full">
                <div className="flex justify-between text-base mb-4 text-slate-600 dark:text-slate-300 font-bold">
                    <span className="flex items-center gap-2"><Server size={18} className="text-[#5291dd] dark:text-slate-400"/> Scanning Critical Enterprise Servers</span>
                    <span className="text-[#5291dd] dark:text-[#E74A33] font-mono tracking-wider">48,291 / 50,000</span>
                </div>
                <div className="w-full h-3 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden shadow-inner flex">
                    <div className="h-full bg-gradient-to-r from-[#E74A33] via-[#E74A33] to-[#5291dd] dark:from-[#5291dd] dark:via-[#E74A33] dark:to-[#5291dd] w-[96%] relative">
        ...
        return (
          <div className="flex items-center justify-center p-12 h-full w-full animate-fade-in-scale">
            ...
            <div className="w-[800px] bg-white dark:bg-[#1C202C] border border-slate-200 dark:border-slate-700/80 rounded-xl overflow-hidden shadow-2xl flex flex-col font-sans transition-colors duration-500 relative">
               ...
               <div className="bg-[#E4E6EB] dark:bg-[#2B313F] h-12 flex items-center justify-between px-4 border-b border-slate-300 dark:border-slate-800">
                  ...
                  <div className="flex items-center gap-2">
                     ...
                     <button className="bg-[#5291dd] dark:bg-[#5291dd] text-white px-3 py-1 text-xs font-bold rounded shadow-sm">Submit</button>
                  </div>
               </div>

               {/* Form Header */}
               <div className="p-5 flex gap-4 border-b border-slate-200 dark:border-slate-700/50 bg-[#F4F5F8] dark:bg-[#151923]">
                  <div className="w-12 h-12 rounded bg-[#5291dd]/10 dark:bg-[#5291dd]/50/20 border border-[#5291dd]/20 dark:border-[#5291dd]/30 flex items-center justify-center">
                    <FileText size={24} className="text-[#5291dd] dark:text-[#5291dd]"/>
                  </div>
                  <div>
               ...
               <div className="p-6 bg-white dark:bg-[#1C202C]">
                   ...
                   <div className="space-y-4">
                     <div>
                       ...
                       <div className="w-full min-h-[32px] bg-slate-50 border border-slate-300 dark:bg-[#13161F] dark:border-slate-600/60 rounded px-2 py-1.5 flex flex-wrap gap-1.5 items-center">
                         ...
                         <span className="bg-[#EC9A1E]/20 dark:bg-[#EC9A1E]/100/20 border border-[#EC9A1E]/30 dark:border-[#EC9A1E]/100/30 text-[#EC9A1E] dark:text-[#EC9A1E] text-[10px] uppercase font-bold px-1.5 py-0.5 rounded shadow-sm">Duplicate</span>
                       </div>
                     </div>
                     <div>
                 ...
                 <div className="mt-6 border-t border-slate-100 dark:border-slate-700/50 pt-5">
                     <label className="block text-xs font-bold text-[#5291dd] dark:text-[#E74A33] mb-2 uppercase tracking-wide flex items-center gap-2"><Sparkles size={12}/> AI Recommended Action</label>
            ...
            {/* Informational overlay popup */}
             <div className="absolute bottom-12 bg-white/90 backdrop-blur-md dark:bg-[#0A101C]/90 border border-slate-200 dark:border-[#E74A33]/30 px-6 py-3 rounded-full shadow-lg dark:shadow-[0_20px_40px_rgba(232,88,15,0.15)] flex items-center gap-3 animate-slide-from-bottom">
               <span className="w-3 h-3 rounded-full bg-[#5291dd]/50 dark:bg-[#E74A33] animate-ping absolute left-6" />
               <p className="text-[#023761] dark:text-[#E74A33] text-sm font-bold tracking-[0.1em] uppercase relative z-10 text-center pl-6">Data populated into native UI Form View</p>
             </div>
          </div>
        )
      case 2:
            ...
            <div className="grid grid-cols-[380px_minmax(140px,1fr)_250px] w-full max-w-[1100px] items-center relative z-10 gap-x-6 gap-y-12">
              ...
              <div className="col-start-1 row-start-1 flex justify-end">
                <div className="w-[380px] bg-white dark:bg-[#1C202C] border border-slate-200 dark:border-slate-700/80 rounded-lg overflow-hidden shadow-xl flex flex-col font-sans relative transition-transform hover:-translate-y-1 cursor-default">
                  <div className="absolute -top-3.5 left-5 bg-[#5291dd]/50 text-white text-[10px] font-black uppercase tracking-widest px-2.5 py-0.5 rounded shadow-sm z-10">Original Form Data</div>
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-2">
                        ...
                        <div>
                          ...
                          <div className="w-full min-h-[32px] bg-slate-50 dark:bg-[#13161F] border border-slate-200 dark:border-slate-700 rounded p-1.5 flex flex-wrap gap-1.5 items-center">
                             ...
                             <div className="px-1.5 py-0.5 bg-[#EC9A1E]/20 text-[#EC9A1E] border border-[#EC9A1E]/30 dark:border-[#EC9A1E]/100/30 dark:bg-[#EC9A1E]/100/20 dark:text-[#EC9A1E] text-[9px] rounded font-bold uppercase shadow-sm">Dup</div>
                          </div>
                        </div>
                      </div>
                  </div>
              ...
              <div className="col-start-2 row-start-1 flex items-center w-full relative h-[40px]">
                  <p className="absolute -top-7 left-1/2 -translate-x-1/2 text-[9px] w-[130px] text-center whitespace-normal leading-tight text-[#5291dd] dark:text-[#5291dd] uppercase tracking-widest font-bold px-1 py-0.5">1. Scripts Extract<br/>Raw Data</p>
                  <div className="h-2 w-full bg-slate-200 dark:bg-[#0A101C] rounded-full relative overflow-hidden shadow-inner border border-slate-300 dark:border-slate-800">
                    ...
                    <div className="absolute left-0 w-64 h-full bg-[#5291dd]/50 dark:bg-[#5291dd] rounded-full animate-data-flux shadow-[0_0_15px_#006A9E] dark:shadow-[0_0_50px_#F7B516,inset_0_0_15px_#fff]" />
              ...
              <div className="col-start-1 row-start-2 flex justify-end">
                <div className="w-[380px] bg-white dark:bg-[#1C202C] border-2 border-[#E74A33] dark:border-[#E74A33]/80 rounded-lg overflow-hidden shadow-[0_10px_30px_rgba(232,88,15,0.15)] flex flex-col font-sans relative transition-transform hover:-translate-y-1 cursor-default">
                  <div className="absolute -top-3.5 left-5 bg-[#E74A33] text-white text-[10px] font-black uppercase tracking-widest px-2.5 py-0.5 rounded shadow-sm z-10 flex items-center gap-1.5"><Sparkles size={12} /> AI Enriched Form</div>
                  <div className="bg-[#E4E6EB] dark:bg-[#2B313F] h-9 flex items-center justify-between px-4 border-b border-slate-300 dark:border-slate-800">
                      <span className="font-bold text-[12px] text-slate-800 dark:text-slate-100">HREC-10901</span>
                  </div>
                  <div className="p-4 bg-white dark:bg-[#1C202C]">
                      ...
                      <div className="border-t border-slate-100 dark:border-slate-700/50 pt-3">
                          <label className="block text-[10px] font-bold text-[#5291dd] dark:text-[#E74A33] mb-1.5 flex items-center gap-1.5"><Sparkles size={10}/> AI Recommended Action</label>
                          <div className="w-full max-h-[160px] overflow-y-auto bg-slate-50 dark:bg-[#0B0F19] border border-slate-200 dark:border-slate-700/50 rounded p-1.5 space-y-1.5 animate-fade-in-scale custom-scrollbar">
                             ...
                             <div className="bg-white dark:bg-[#161B22] border border-slate-200 dark:border-slate-700/60 rounded flex flex-col p-2 gap-1.5 shadow-sm">
                                <div className="flex items-center gap-2">
                                   <div className="flex items-center gap-1.5 px-1.5 py-0.5 border border-[#EC9A1E]/30 dark:border-[#EC9A1E]/100/30 bg-[#EC9A1E]/10/50 dark:bg-[#EC9A1E]/100/10 rounded text-[8px] font-black uppercase text-[#EC9A1E] dark:text-[#EC9A1E] tracking-wide">
                                     <span className="w-[3.5px] h-[3.5px] rotate-45 bg-[#EC9A1E]/100"></span> High
                                   </div>
                                   <span className="text-[11px] font-bold text-slate-800 dark:text-slate-100">Duplicate entry detected</span>
                                </div>
                                <div className="flex items-start gap-2 pl-1">
                                   <div className="px-1.5 py-0.5 border border-[#EC9A1E]/40 dark:border-[#EC9A1E]/50 rounded text-[8px] font-black text-[#EC9A1E] dark:text-[#EC9A1E] uppercase tracking-wide">FIX</div>
                                   <span className="text-[10px] font-bold text-[#EC9A1E]/90 dark:text-[#EC9A1E] leading-snug">Merge US-EAST-DB-001 with primary active record to resolve compliance violations.</span>
                                </div>
                             </div>
              ...
              <div className="col-start-2 row-start-2 flex items-center w-full relative h-[40px] scale-x-[-1]">
                  <p className="absolute -bottom-7 left-1/2 -translate-x-1/2 text-[9px] w-[130px] text-center whitespace-normal leading-tight text-[#5291dd] dark:text-[#E74A33] uppercase tracking-widest font-bold px-1 py-0.5 scale-x-[-1]">2. Push Native<br/>Recommendations</p>
                  <div className="h-2 w-full bg-slate-200 dark:bg-[#0A101C] rounded-full relative overflow-hidden shadow-inner border border-slate-300 dark:border-slate-800">
                    <div className="absolute w-full h-px bg-slate-300 dark:bg-slate-700 top-1/2 -translate-y-1/2" />
                    <div className="absolute left-0 w-64 h-full bg-[#E74A33] dark:bg-[#E74A33] rounded-full animate-data-flux shadow-[0_0_15px_#E8580F] dark:shadow-[0_0_50px_#E8580F,inset_0_0_15px_#fff]" style={{ animationDelay: '1.2s' }} />
              ...
              <div className="col-start-3 row-start-1 row-span-2 flex items-stretch justify-center pl-4 py-8">
                <div className="w-[250px] h-full bg-white dark:bg-gradient-to-b dark:from-[#1B122A] dark:to-[#0D0814] border border-slate-200 dark:border-[#E74A33]/50 rounded-[2rem] p-8 flex flex-col items-center justify-center shadow-[0_20px_40px_rgba(0,0,0,0.1)] dark:shadow-[0_30px_80px_rgba(232,88,15,0.3)] z-20 shrink-0 relative overflow-hidden group">
                   <div className="absolute inset-0 bg-[#E74A33]/5 dark:bg-[#E74A33]/20 blur-3xl group-hover:opacity-100 opacity-50 transition-opacity" />
                   <div className="absolute top-0 inset-x-0 h-1 bg-gradient-to-r from-transparent via-[#E74A33]/50 to-transparent opacity-50" />
                   <BrainCircuit className="text-[#E74A33] dark:text-[#F7B516] w-20 h-20 mb-6 relative z-10 drop-shadow-md dark:drop-shadow-[0_0_25px_rgba(232,88,15,0.7)] animate-pulse" />
                   <div className="text-lg font-black text-slate-800 dark:text-white relative z-10 tracking-tight text-center leading-tight">
                     Enterprise LLM
                     <span className="block text-[11px] text-slate-500 dark:text-[#E74A33]/80 font-bold uppercase tracking-widest mt-1.5">or Native Now Assist</span>
                   </div>
                   <div className="text-[10px] font-bold text-white mt-4 relative z-10 bg-[#E74A33] dark:bg-[#E74A33]/40 px-5 py-2 rounded-full border border-[#E74A33]/50 dark:border-[#E74A33]/50 uppercase tracking-widest shadow-[0_0_15px_rgba(232,88,15,0.4)] animate-pulse">Inferencing...</div>
                </div>
              </div>
            ...
            <div className="w-full h-full bg-[#f4f5f8] dark:bg-[#1A1F2D] rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden flex flex-col font-sans shadow-lg dark:shadow-2xl relative transition-colors duration-500">
                ...
                <div className="flex-1 overflow-auto bg-[#F4F5F8] dark:bg-[#131722] p-5 flex flex-col gap-4">
                  ...
                  <div className="flex items-center justify-between mb-2">
                     ...
                     <div className="flex items-center gap-3">
                        <button className="flex items-center gap-2 px-4 py-2 bg-[#023761] text-white rounded-full text-sm font-semibold shadow-[0_4px_10px_rgba(16,98,64,0.3)] dark:bg-[#2D3956] dark:text-[#E74A33] hover:opacity-90 transition-all">
                  ...
                  <div className="flex gap-4">
                     {[
                       ...
                       return (
                         <div key={idx} className={`flex-1 rounded-2xl flex flex-col p-5 shadow-sm transition-all relative ${isMain ? 'bg-[#023761] dark:bg-[#1A2131] border-transparent dark:border-slate-700' : 'bg-white dark:bg-[#1A2131] border border-slate-200 dark:border-slate-700'} dark:border-b-2 dark:border-b-blue-500`}>
                           ...
                           <span className={`text-[11px] font-medium flex items-center gap-1.5 ${isMain ? 'text-[#A3E0C4] dark:text-slate-500' : 'text-slate-500'}`}>
                             <span className={`px-1 rounded flex items-center text-[8px] border font-bold ${isMain ? 'bg-[#3DA574]/20 border-[#3DA574] text-white' : 'bg-[#023761]/10 border-[#023761]/30 text-[#023761] dark:bg-transparent dark:text-slate-400'}`}>+5%</span>
                             {wg.trend}
                           </span>
                         </div>
                       )
                  ...
                  <div className="flex items-center gap-3 py-2">
                     <div className="flex bg-white dark:bg-[#1A2131] rounded-full border border-slate-200 dark:border-slate-700/60 p-1 shadow-sm">
                        {['ALL','CRITICAL','MODERATE'].map((f, i) => (
                          <button key={f} className={`px-5 py-1.5 rounded-full text-[12px] font-semibold transition-colors ${i===0 ? 'bg-[#023761] text-white dark:bg-blue-600 shadow' : 'text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white'}`}>
                            {f}
                          </button>
                        ))}
                     </div>
                     ...
                     {[
                       ...
                       <div key={i} className="bg-white dark:bg-[#1A2131] border border-slate-200 dark:border-slate-700/60 rounded-2xl overflow-hidden flex flex-col shadow-sm dark:shadow-lg transition-colors group">
                          ...
                          <div className="px-5 py-4 flex flex-wrap gap-2 auto-rows-max">
                             {card.pills.map((p, idx) => (
                                <span key={idx} className={`px-2.5 py-1 text-[9px] font-bold rounded-md border ${
                                  ...
                                  p.includes('MISSING') ? 'bg-[#EC9A1E]/10 text-[#EC9A1E] border-[#EC9A1E]/30 dark:bg-[#EC9A1E]/100/10 dark:border-[#EC9A1E]/100/20 dark:text-[#EC9A1E]' :
                          ...
                          <div className="px-5 py-4 mt-auto border-t border-slate-100 dark:border-slate-700/50 flex justify-between items-center bg-white dark:bg-[#181D29]">
                             ...
                             <button className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#023761] text-white text-xs font-semibold hover:bg-[#023761] dark:bg-[#EC9A1E]/100/20 dark:text-[#EC9A1E] dark:border dark:border-[#EC9A1E]/100/50 transition-colors shadow">
    ...
    <section className="w-full h-full flex bg-[#F0F2F5] dark:bg-transparent transition-colors duration-500">
      ...
      <div className="w-[420px] bg-white dark:bg-[#0A0F1D]/80 backdrop-blur-2xl border-r border-slate-200 dark:border-slate-700/50 p-8 flex flex-col z-20 shadow-[20px_0_40px_-20px_rgba(0,0,0,0.05)] dark:shadow-[20px_0_40px_-20px_rgba(0,0,0,0.8)] relative transition-colors duration-500">
        <div className="mb-2">
           ...
           <p className="text-[#023761] dark:text-[#E74A33] font-bold tracking-widest uppercase text-xs mt-3 bg-[#5291dd]/5 border-[#5291dd]/20 dark:bg-[#E74A33]/10 inline-block px-3 py-1 rounded-full border dark:border-[#E74A33]/20">Active Execution</p>
        </div>

        {/* Controls */}
        <div className="my-6 flex gap-4 h-12 relative z-50">
          <button onClick={() => setAutoplay(a => !a)} className={`flex-1 flex items-center justify-center gap-3 text-sm font-black tracking-wide rounded-full transition-all duration-300 shadow-lg border-2 ${autoplay ? 'bg-[#5291dd]/10 hover:bg-[#5291dd]/10 text-[#023761] border-[#5291dd]/20 dark:bg-[#E74A33]/10 dark:hover:bg-[#E74A33]/20 dark:text-[#E74A33] dark:border-[#E74A33]/30' : 'bg-white hover:bg-slate-50 text-slate-800 border-slate-200 dark:bg-[#1A2235] dark:hover:bg-[#232E45] dark:text-white dark:border-slate-700/80'}`}>
            {autoplay ? <><Pause size={18} className="animate-pulse" /> PAUSE</> : <><Play size={18} className="text-[#5291dd] dark:text-[#E74A33]"/> AUTO</>}
          </button>
          <button onClick={() => { setAutoplay(false); goToStep(step + 1) }} disabled={step === STEPS.length - 1} className="flex-1 flex items-center justify-center gap-2 bg-[#5291dd] hover:bg-[#023761] text-white dark:bg-[#E74A33] dark:hover:bg-[#E74A33] border border-transparent text-sm font-black tracking-wide rounded-full transition-all duration-300 shadow-[0_10px_20px_rgba(79,70,229,0.25)] dark:shadow-[0_10px_20px_rgba(232,88,15,0.25)] group disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:translate-y-0 hover:-translate-y-0.5">
            ...
            return (
              <div 
                ...
                className={`flex items-center gap-4 cursor-pointer p-3.5 rounded-2xl border transition-all duration-300 group
                           ${isActive ? 'bg-white border-[#5291dd]/50 shadow-[0_10px_30px_rgba(0,106,158,0.15)] dark:border-[#E74A33] dark:bg-[#0F1725] dark:shadow-[0_10px_30px_rgba(232,88,15,0.15)] scale-105 relative z-10' 
              ...
              >
                <div className={`w-12 h-12 rounded-full flex items-center justify-center border-2 transition-colors flex-shrink-0
                   ${isActive ? 'bg-[#5291dd]/5 border-[#5291dd]/50 text-[#5291dd] dark:bg-[#E74A33]/20 dark:border-[#E74A33] dark:text-[#E74A33] shadow-sm dark:shadow-[0_0_15px_rgba(52,211,153,0.5)]' 
                   : 'bg-white border-slate-300 text-slate-400 dark:bg-[#131A26] dark:border-slate-700 dark:text-slate-500'}`}>
                  {isDone ? <CheckCircle2 size={24} className="text-[#E74A33] dark:text-[#E74A33]" /> : <span className="font-black text-lg">{i + 1}</span>}
                </div>
                <div className="flex-1">
                  ...
                  {isActive && <p className="text-xs text-slate-600 dark:text-[#E74A33]/80 mt-1 font-medium leading-snug">{s.desc}</p>}
                </div>
              </div>
            )
          })}
      ...
      <div className="flex-1 relative overflow-hidden bg-white dark:bg-[#0A0D14] transition-colors duration-500">
         ...
         <div className="absolute top-0 inset-x-0 h-20 border-b border-slate-200 dark:border-slate-700/60 bg-white/80 dark:bg-[#0B101C]/80 backdrop-blur-xl flex items-center px-10 z-30 justify-between">
             <div className="flex items-center gap-3 bg-[#5291dd]/5 dark:bg-[#E74A33]/10 border border-[#5291dd]/20 dark:border-[#E74A33]/30 px-5 py-2 rounded-full shadow-sm dark:shadow-[0_0_20px_rgba(232,88,15,0.15)]">
                 <div className="w-2.5 h-2.5 rounded-full bg-[#5291dd] dark:bg-[#E74A33] animate-pulse drop-shadow-sm dark:drop-shadow-[0_0_5px_#E8580F]" />
                 <span className="text-xs font-extrabold text-[#023761] dark:text-[#E74A33] tracking-[0.15em] uppercase">Enterprise Simulation Node</span>
             </div>
             {step === 3 && (
